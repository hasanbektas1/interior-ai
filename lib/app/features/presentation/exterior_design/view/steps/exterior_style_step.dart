...
class ExteriorStyleStep extends StatelessWidget {
  const ExteriorStyleStep({super.key, required this.state});

  final ExteriorDesignState state;

  Future<void> _onSelect(BuildContext context, ExteriorStyle style) async {
    ...
    final prompt = await CustomStyleBottomSheet.show(
      context,
      promptLibrary: AppStrings.exteriorPromptLibraryItems,
